-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('PENDING', 'SUCCESS', 'CANCELLED', 'PROCESSING');

-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('USER', 'ADMIN');

-- CreateEnum
CREATE TYPE "UserStatus" AS ENUM ('ACTIVE', 'INACTIVE', 'INDEBTED', 'BANNED', 'DELETED');
...
-- CreateTable
CREATE TABLE "GearboxManufacturer" (
    "id" SERIAL NOT NULL,
    "name" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "GearboxManufacturer_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "_GearboxManufacturerToProduct" (
    "A" INTEGER NOT NULL,
    "B" INTEGER NOT NULL
);
...
-- CreateIndex
CREATE UNIQUE INDEX "_GearboxManufacturerToProduct_AB_unique" ON "_GearboxManufacturerToProduct"("A", "B");

-- CreateIndex
CREATE INDEX "_GearboxManufacturerToProduct_B_index" ON "_GearboxManufacturerToProduct"("B");
...
-- AddForeignKey
ALTER TABLE "_GearboxManufacturerToProduct" ADD CONSTRAINT "_GearboxManufacturerToProduct_A_fkey" FOREIGN KEY ("A") REFERENCES "GearboxManufacturer"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_GearboxManufacturerToProduct" ADD CONSTRAINT "_GearboxManufacturerToProduct_B_fkey" FOREIGN KEY ("B") REFERENCES "Product"("id") ON DELETE CASCADE ON UPDATE CASCADE;
