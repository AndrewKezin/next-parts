...
// }, []);
    ...
    const text = `Согласие Пользователя
на обработку персональных данных 

В соответствии со статьями 23, 24 Конституции Российской Федерации, Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных», Правилами обработки персональных данных, размещенными на сайте ------------ по адресу: ____________ (далее-Правила обработки ПДн),
...
1. Согласие выдано Обществу с ограниченной ответственностью «------------» (ООО «--------», ИНН -----------, ОГРН ---------), расположенному по адресу: -------(далее-Оператор).
...
5.1. Ознакомлен и согласен с тем, что передача персональных данных Пользователя может осуществляться Оператором в объеме, необходимом для получения Пользователем доступа к Сайту, его Содержанию и/или его Сервису, следующим третьим лицам: ________________________________________________.
...
6. Согласие вступает в силу с момента его отправки и может быть отозвано Пользователем путем направления письменного заявления в произвольной форме в адрес Оператора по адресу электронной почты _____________ либо иным способом, позволяющим однозначно определить факт его получения адресатом. 
...
`
    ...
    return (
        <Container>
            <h1 className='text-4xl font-bold mt-10 mb-5 w-[800px]'>Согласие на обработку персональных данных</h1>
