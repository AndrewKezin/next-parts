...
import { GroupVariants, IngredientItem, ProdItemCounter, ProductImage } from '@/components/shared';
      ...
      <div className="flex-1 bg-[#f7f6f5] p-3 md:p-7 rounded-md">
        ...
        {currentItemIdCount !== undefined && (
          <>
            ...
            {ingredients.length > 0 && currentItemIdCount > 0 && (
              <div className="bg-gray-50 p-1 lg:p-3 rounded-md h-auto overflow-auto invisible-scrollbar">
