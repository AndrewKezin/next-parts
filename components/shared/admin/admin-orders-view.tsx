...
import { OrderNotExist } from './order-not-exist';
...
export const AdminOrdersView: React.FC<Props> = ({ orders, handleClearSearch, className }) => {
  if (orders.every((order) => order === null)) {
    return <OrderNotExist handleClearSearch={handleClearSearch} />;
  }
