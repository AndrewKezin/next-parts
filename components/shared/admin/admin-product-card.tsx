          ...
          <div className="flex flex-1 flex-col items-center justify-center p-2 gap-2">
            ...
            {product.items.length === 1 && (
              <div className="w-full flex items-center justify-center gap-1 ">
                ...
                {product.items[0].quantityOfTeeth && (
                  <div className="mx-1">Кол-во зубов диска: {product.items[0].quantityOfTeeth}</div>
                )}
                {product.items[0].thickness && (
                  <div className="mx-1">Толщина диска: {product.items[0].thickness} мм</div>
                )}
                {product.items[0].volume && (
                  <div className="mx-1">Объём канистры масла: {product.items[0].volume} л</div>
                )}
